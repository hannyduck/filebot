...
module.exports.run = async function({
    ...
    try {
        const out = (a, b) => api.sendMessage(`${a} \n Nhà cái Đtai :)`, event.threadID, b?event.messageID: null),
        {
            data
        } = (await get(`https://api.nguyenlienmanh.com/v2/tien-ich/check-xsmb.json`)).data
        if (!!args[0]) {
